...
public class AListTest {
    ...
    {
        list.reverse();
        assertTrue(list.master[0].equals("Seoul"));
        assertTrue(list.master[1].equals("Sao Paulo"));
        assertTrue(list.master[2].equals("New York"));
        assertTrue(list.master[3].equals("Tokyo"));
    }
}
