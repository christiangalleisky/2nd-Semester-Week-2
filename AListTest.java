...
public class AListTest {
    ...
    {
        String returned = list.getLongest();
        assertEquals( returned, "Sao Paulo");
    }
    ...
    {
        list.reverse();
        assertTrue(list.getMasteratI(0).equals("Seoul"));
        assertTrue(list.getMasteratI(1).equals("Sao Paulo"));
        assertTrue(list.getMasteratI(2).equals("New York"));
        assertTrue(list.getMasteratI(3).equals("Tokyo"));
    }
}
